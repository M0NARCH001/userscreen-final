...
import { getAllEvents } from "@/components/events/event-list";
            ...
            <main className="flex-1 container mx-auto px-4 py-8 md:py-24 max-w-6xl mt-20">
                ...
                <div className="flex flex-col lg:flex-row items-start gap-6 mb-16">
                    ...
                    <div className="flex-1 w-full lg:w-auto">
                        <h1 className="text-3xl md:text-4xl font-bold text-[#0C1D37] mb-6 text-left font-bricolage">
                            {event.title}
                        </h1>
                        <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm sticky top-24">
                            <h2 className="text-xl font-semibold text-[#0C1D37] mb-6">Enter Your Details</h2>
                            <form className="space-y-6">
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-11 px-3 rounded-md border border-gray-400 focus:outline-none focus:border-[#0C1D37] text-sm placeholder:text-gray-300 placeholder:font-light"
                                    />
                                </div>
                                <div className="relative">
                                ...
                                <Button className="w-full h-11 mt-4 bg-[#0C1D37] text-white font-medium hover:bg-[#0C1D37]/90 rounded-full text-base">
                                    Pay
                                </Button>
                            </form>
                        </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-6 gap-x-12 mb-12">
                    <div>
                        <p className="font-semibold text-[#0C1D37] text-lg mb-1">Date: 21st March 2025</p>
                    </div>
                    <div>
                        <p className="font-semibold text-[#0C1D37] text-lg mb-1">Time: 8 AM Onwards</p>
                    </div>
                    <div>
                        <p className="font-semibold text-[#0C1D37] text-lg mb-1">Venue: <span className="underline decoration-1 underline-offset-4">Qubaa, Visakhapatnam</span></p>
                    </div>
                    <div>
                        <p className="font-semibold text-[#0C1D37] text-lg mb-1">Age Eligibility: 21+ Years</p>
                    </div>
                    <div>
                        <p className="font-semibold text-[#0C1D37] text-lg mb-1">Event Duration: 4hrs</p>
                    </div>
                    <div>
                        <p className="font-semibold text-[#0C1D37] text-lg mb-1">Entry Time: 7 PM Onwards</p>
                    </div>
                </div>
                ...
                <div className="space-y-8 max-w-4xl">
                    ...
                    <div className="border border-gray-200 rounded-xl p-8 bg-white shadow-sm">
                        <h3 className="font-bold text-lg text-[#0C1D37] mb-4">About the Event</h3>
                        ...
                        <h3 className="font-bold text-lg text-[#0C1D37] mb-4">Event Highlights</h3>
                    ...
                    <div className="border border-gray-200 rounded-xl p-8 bg-white shadow-sm text-center">
                        <div className="flex justify-center mb-4">
                            <CalendarX2 className="h-10 w-10 text-[#0C1D37]" />
                        </div>
                        <h3 className="font-bold text-lg text-[#0C1D37] mb-2">Can&apos;t make it this time?</h3>
                        ...
                        <Dialog>
                            <DialogTrigger asChild>
                                <Button className="bg-[#0C1D37] text-white hover:bg-[#0C1D37]/90 rounded-full px-6">
                            ...
                            <DialogContent className="p-0 overflow-hidden max-w-[360px] rounded-3xl bg-white border-0">
                                ...
                                <div className="px-4">
                                    <Calendar
                                        ...
                                        classNames={{
                                            ...
                                            cell: "text-center text-sm p-0 flex items-center justify-center h-10 w-10 relative [&:has([aria-selected])]:bg-[#0C1D37] [&:has([aria-selected])]:rounded-full focus-within:relative focus-within:z-20",
                                            day: "h-10 w-10 p-0 font-normal text-gray-900 aria-selected:opacity-100 hover:bg-gray-100 rounded-full",
                                            day_selected: "bg-[#0C1D37] text-white hover:bg-[#0C1D37] hover:text-white focus:bg-[#0C1D37] focus:text-white",
                                ...
                                <div className="p-4 flex justify-between items-center bg-white">
                                    <DialogClose asChild>
                                        <Button variant="ghost" className="text-[#0C1D37] font-medium hover:bg-gray-50 text-sm">
                                            Close
                                        </Button>
                                    </DialogClose>
                                    <div className="flex gap-2">
                                        ...
                                        <DialogClose asChild>
                                            <Button className="text-[#0C1D37] font-medium bg-transparent hover:bg-gray-50 text-sm px-4">
                                                OK
                                            </Button>
                                        </DialogClose>
                                    </div>
                    ...
                    <div className="space-y-8">
                        <Accordion type="single" collapsible className="w-full">
                            <AccordionItem value="item-1" className="border border-gray-200 rounded-xl bg-white px-6 data-[state=open]:pb-4 last:border-b">
                                <AccordionTrigger className="hover:no-underline font-bold text-[#0C1D37] text-lg py-6">
                                    Terms & Conditions
                                </AccordionTrigger>
                            ...
                            <AccordionItem value="item-2" className="border border-gray-200 rounded-xl bg-white px-6 data-[state=open]:pb-4 last:border-b">
                                ...
                                <AccordionContent className="text-gray-600">
                                    <div className="space-y-6 pt-2">
                                        {/* Top Info */}
                                        <div className="flex flex-col md:flex-row gap-4 md:gap-8 text-sm text-[#0C1D37] font-medium border-b border-gray-100 pb-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                            ...
                                            <div className="space-y-8">
                                                {/* First time */}
                                                <div>
                                                    <h4 className="font-bold text-[#0C1D37] mb-3 text-base">First time coming?</h4>
                                                ...
                                                <div className="space-y-6">
                                                    <div>
                                                        <h4 className="font-bold text-[#0C1D37] mb-2 text-base flex items-center gap-2">
